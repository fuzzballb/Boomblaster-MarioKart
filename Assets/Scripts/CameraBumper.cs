...
class CameraBumper
{
    ...
    [SerializeField]
    private CollisionType collisionType = CollisionType.Raycast; // length of bumper ray
    ...
    [SerializeField]
    private float distanceCheck = 2.5f; // length of bumper
    ...
    [SerializeField]
    private float newCameraHeight = 1.0f; // adjust camera height while bumping
    ...
    [SerializeField]
    private Vector3 offset = Vector3.zero; // allows offset of the bumper ray from target origin
