...
class SmoothCameraAdvanced : MonoBehaviour
{
    ...
    [SerializeField]
    List<CameraControl> controls = new List<CameraControl>();
    ...
    [SerializeField]
    private Vector3 lookAtOffset; // allows offsetting of camera lookAt, very useful for low bumper heights
    ...
    [SerializeField]
    private LimitedFloat distance = new LimitedFloat(3.0f, 1, 10);
    ...
    [SerializeField]
    private LimitedFloat height = new LimitedFloat(1.0f, 1, 5);
    ...
    [SerializeField]
    private LimitedFloat panX = new LimitedFloat(0.0f, -1, 1);
    ...
    [SerializeField]
    private LimitedFloat panY = new LimitedFloat(0.0f, 0, 2);
